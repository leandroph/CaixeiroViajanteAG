...
public class Tour {
 ...
 private ArrayList<City> _tour = new ArrayList<City>();
 //Fitness da rota - Representa o quão boa é a rota. O fitness é inversamente proporcional 
//à distancia, pois queremos encontrar a menor rota
